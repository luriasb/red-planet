<template>
  <div :class="['relative z-50 bg-gray-400 text-white', bodyClasses]">
    <div class="px-0 py-0 mx-auto w-full lg:px-4 text-base max-w-screen-xl">
      <div class="relative flex items-center justify-end py-6 lg:py-0">
        ...
        <div class="flex justify-end flex-grow px-6">
        ...
        <ul class="flex items-center hidden space-x-8 lg:flex border-l py-5">
          <li>
            <a
              :href="hrefPhone"
              class="inline-flex items-center justify-end h-12 px-6 font-base tracking-wide"
              aria-label="Phone"
              title="Phone"
            >
              {{ phone }}
        ...
        <div class="lg:hidden text-lg"> <!--hidden menu-->
          <button
          ...
          <div v-if="isMenuOpen" class="absolute top-[80px] left-0 w-full">
